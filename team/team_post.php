...
require '../db.php';
    ...
    $team_subhead = $_POST['team_subhead'];
    $description = $_POST['description'];

    $uploaded_file= $_FILES['team_pic'];
...
if(in_array($extension,$allowed_extesion)){
        if($uploaded_file['size'] <= 600000) {
                $insert = "INSERT INTO teams(team_heading,team_subhead,description) VALUES('$heading','$team_subhead','$description')";
                ...
                $uploaded_photo_name = "UPDATE teams SET team_pic='$file_name' WHERE id=$last_id";
                $update_result= mysqli_query($db_conn,$uploaded_photo_name);
            
                $_SESSION['team_content'] = "Team Section Add  Succesessfully";
                header('location:/webcit/team/add_team.php');
